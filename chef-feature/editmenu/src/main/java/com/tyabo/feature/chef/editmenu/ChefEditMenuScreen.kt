...
fun ChefEditMenuScreen(
    ...
    when(state){
        ...
        is EditMenuViewState.Youtube -> {
            ...
            com.tyabo.feature.chef.editmenu.components.YoutubeScreen(
...
private fun EditMenuScreen(
    ...
    Scaffold(
        topBar = {
            com.tyabo.feature.chef.editmenu.components.MainTopBar(
                navigateUp = navigateUp,
        ...
        Column(
            ...
            com.tyabo.feature.chef.editmenu.components.MenuPicture(menuProfileUrl, onPictureUpdate)
            com.tyabo.feature.chef.editmenu.components.MenuName(
                modifier = Modifier
                    .fillMaxWidth()
            ...
            Row(
                ...
                com.tyabo.feature.chef.editmenu.components.MenuPrice(
                    modifier = Modifier.widthIn(max = 100.dp),
                    price = price,
                    onPriceUpdate = onPriceUpdate
                )
                com.tyabo.feature.chef.editmenu.components.SelectNumberPersons(
                    modifier = Modifier.padding(start = 8.dp),
                    numberPersons = numberPersons,
                    onNumberPersonsUpdate = onNumberPersonsUpdate
                )
            }
            com.tyabo.feature.chef.editmenu.components.MenuDescription(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(horizontal = 16.dp, vertical = 4.dp),
            ...
            com.tyabo.feature.chef.editmenu.components.VideoScreen(
                videoState = videoState,
